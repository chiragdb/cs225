...
==99==   total heap usage: 2,474 allocs, 2,474 frees, 286,040 bytes allocated
==99== 
...
==133==   total heap usage: 2,331 allocs, 2,331 frees, 281,452 bytes allocated
==133== 
...
==135==    at 0x42A082: List<int>::print(std::__1::basic_ostream<char, std::__1::char_traits<char> >&) const (List-given.hpp:130)
==135==    by 0x43F193: ____C_A_T_C_H____T_E_S_T____2() (test_part2_extra.cpp:41)
==135==    by 0x47B852: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==135==    by 0x46BFA6: Catch::TestCase::invoke() const (catch.hpp:10793)
==135==    by 0x46BEDC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==135==    by 0x468436: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==135==    by 0x466A0E: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==135==    by 0x46FDA6: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==135==    by 0x46EA42: Catch::Session::runInternal() (catch.hpp:10149)
==135==    by 0x46E70A: Catch::Session::run() (catch.hpp:10106)
==135==    by 0x46E689: Catch::Session::run(int, char**) (catch.hpp:10074)
==135==    by 0x49B701: main (catch.hpp:13613)
==135== 
==135== 
==135== HEAP SUMMARY:
...
==137==   total heap usage: 2,345 allocs, 2,345 frees, 281,664 bytes allocated
==137== 
...
==148== Command: ./test -r xml "List::triplerotate\ edge"
==148== 
==148== 
==148== HEAP SUMMARY:
==148==     in use at exit: 0 bytes in 0 blocks
==148==   total heap usage: 2,473 allocs, 2,473 frees, 286,016 bytes allocated
==148== 
...
==150==   total heap usage: 2,479 allocs, 2,479 frees, 286,200 bytes allocated
==150== 
