...
==94==   total heap usage: 2,359 allocs, 2,359 frees, 268,680 bytes allocated
==94== 
...
==126==    at 0x429B02: List<int>::print(std::__1::basic_ostream<char, std::__1::char_traits<char> >&) const (List-given.hpp:130)
==126==    by 0x43BA33: ____C_A_T_C_H____T_E_S_T____2() (test_part2_extra.cpp:41)
==126==    by 0x474762: Catch::TestInvokerAsFunction::invoke() const (catch.hpp:10892)
==126==    by 0x464EB6: Catch::TestCase::invoke() const (catch.hpp:10793)
==126==    by 0x464DEC: Catch::RunContext::invokeActiveTestCase() (catch.hpp:9658)
==126==    by 0x461346: Catch::RunContext::runCurrentTest(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char> >&) (catch.hpp:9622)
==126==    by 0x45F91E: Catch::RunContext::runTest(Catch::TestCase const&) (catch.hpp:9408)
==126==    by 0x468CB6: Catch::(anonymous namespace)::runTests(std::__1::shared_ptr<Catch::Config> const&) (catch.hpp:9948)
==126==    by 0x467952: Catch::Session::runInternal() (catch.hpp:10149)
==126==    by 0x46761A: Catch::Session::run() (catch.hpp:10106)
==126==    by 0x467599: Catch::Session::run(int, char**) (catch.hpp:10074)
==126==    by 0x494611: main (catch.hpp:13613)
==126== 
==126== 
==126== HEAP SUMMARY:
...
This report was generated for **cbhatia3** using **1789529936ccff17f8fa3034789d062534aa5325** (latest commit as of **October 3rd 2021, 3:40 pm**)
